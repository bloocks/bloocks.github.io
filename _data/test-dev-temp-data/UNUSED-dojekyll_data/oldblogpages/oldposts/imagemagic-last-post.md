...
color: "danger is-family-secondary is-bold"
name: "Launch!"
icon: "rocket"
fixed_navbar: true
lightbox: true
...
{% picture eggs.jpg --img loading="lazy" %}

{% picture dog.png 16:9 tablet: dog.png 4:3 mobile: dog.png 1:1 --img loading="lazy" %}

{% picture lazy bike.jpg 16:9 north --link {{ page.url }} %}


[{% cloudinary /images/eggs.jpg alt="eggs!" %}](https://youtu.be/iWowJBRMtpc?t=90s)
