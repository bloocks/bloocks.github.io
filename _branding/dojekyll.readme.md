...
{% assign text='include.content' | append: i %}
...
{% include anime/test.html bottone='download' %}
{% endcapture %}-->
...
- [X] **Usato electerious con modalmonitor** implementare un bloocks hero per i modal in electerious che non ha il primo div con class hero ma la class hero va aggiunta alle istruzioni java del modal quando viene richiamato popup modal ligthbox per marketing
  ...
  - https://github.com/helpscout/modalmonitor
  - https://www.solodev.com/blog/web-design/adding-a-popup-slider-to-your-website.stml
...
- [X] **Parziale** json file per colori e dimensioni testo Implementato per meta con i file _data/.yml https://jekyllrb.com/docs/datafiles/ 
...
- https://github.com/jekyll/jekyll/issues/2573
...
- [X] **Usato electerious con modalmonitor** implementare un bloocks hero per i modal in electerious che non ha il primo div con class hero ma la class hero va aggiunta alle istruzioni java del modal quando viene richiamato popup modal ligthbox per marketing
  ...
  - https://github.com/helpscout/modalmonitor
  - https://www.solodev.com/blog/web-design/adding-a-popup-slider-to-your-website.stml
  - https://www.html.it/articoli/messaggi-agli-utenti-con-javascript/
  - https://css-tricks.com/comparing-the-different-types-of-native-javascript-popups/
  - https://awesomeopensource.com/projects/modal
